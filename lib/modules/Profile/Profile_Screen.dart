                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 10.0,),
                      Image(image: NetworkImage('${ASSETSBASEURL}Levels/${user!.charging_level_icon}') , width: 35,),
                    ],
                  ),
                  Row(
                    children: [
                ...
                children: [
                  Expanded(
                    child: GestureDetector(
                      onTap: () {Navigator.push(context, MaterialPageRoute(builder: (ctx) => const FollowersScreen()));},
                      child: Column(
                        children: [
                      ...
                      children: [
                        ...
                        Shimmer(
                          ...
                          child: Container(
                            ...
                            child: Text('Purchase' , style: TextStyle(color: Colors.white , fontSize: 16.0),),
                          ),
                        )
                      ],
                    ),
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("Gold" , style: TextStyle(color: MyColors.primaryColor , fontSize: 22.0 , fontWeight: FontWeight.bold),),
                              SizedBox(height: 10.0,),
                              Row(
                                children: [
                                  Image(image: AssetImage('assets/images/gold.png') , width: 35.0, height: 35.0,),
                                  SizedBox(width: 5.0,),
                                  Text(user!.gold , style: TextStyle(color: MyColors.primaryColor , fontSize: 22.0 , fontWeight: FontWeight.bold),),
                                ],
                              )
                            ],
                          ),
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("Diamond" , style: TextStyle(color: MyColors.blueColor.withOpacity(.9) , fontSize: 22.0 , fontWeight: FontWeight.bold),),
                              SizedBox(height: 10.0,),
                              Row(
                                children: [
                                  Image(image: AssetImage('assets/images/diamond.png') , width: 35.0, height: 35.0,),
                                  SizedBox(width: 5.0,),
                      ...
                      child: Column(
                        ...
                        children: [
                          CircleAvatar(
                            ...
                            child: Image(image: AssetImage('assets/images/diamond.png') , width: 30.0,),
                          ),
                          SizedBox(height: 5.0,),
                          Text("My Room" , style: TextStyle(color: MyColors.whiteColor , fontSize: 13.0 ),)
                        ],
                      ),
                    ),
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          CircleAvatar(
                            radius: 25.0,
                            backgroundColor: Colors.orangeAccent.withAlpha(80),
                            child: Image(image: AssetImage('assets/images/diamond.png') , width: 30.0,),
                          ),
                          SizedBox(height: 5.0,),
                          Text("Mall" , style: TextStyle(color: MyColors.whiteColor , fontSize: 13.0 ),)
                        ],
                      ),
                    ),
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 5.0,),
                          Text("Gifts" , style: TextStyle(color: MyColors.whiteColor , fontSize: 13.0 ),)
                        ],
                      ),
                    ),
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 5.0,),
                          Text("Level" , style: TextStyle(color: MyColors.whiteColor , fontSize: 13.0 ),)
                        ],
                      ),
                    ),
                  ],
