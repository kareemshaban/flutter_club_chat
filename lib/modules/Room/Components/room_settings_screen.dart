        ...
        children: [
          ...
          Row(
            children: [
              ...
              SizedBox(width: 10.0,),
              Text("room_settings_room_title".tr, style: TextStyle(color: Colors.white , fontSize: 16.0 , fontWeight: FontWeight.bold),)
            ],
          ),
          SizedBox(height: 8.0,),
          Row(
          ...
          Row(
            children: [
              ...
              SizedBox(width: 10.0,),
              Text("room_settings_hello".tr, style: TextStyle(color: Colors.white , fontSize: 16.0 , fontWeight: FontWeight.bold),)
            ],
          ),
          SizedBox(height: 8.0,),
          Row(
          ...
          Row(
            children: [
              ...
              SizedBox(width: 10.0,),
              Text("room_settings_room_password".tr, style: TextStyle(color: Colors.white , fontSize: 16.0 , fontWeight: FontWeight.bold),)
            ],
          ),
          SizedBox(height: 8.0,),
          Row(
          ...
          Row(
            children: [
              ...
              SizedBox(width: 10.0,),
              Text("room_settings_room_subject".tr, style: TextStyle(color: Colors.white , fontSize: 16.0 , fontWeight: FontWeight.bold),)
            ],
          ),
          ...
          Row(
            children: [
              ...
              SizedBox(width: 10.0,),
              Text("room_settings_room_img".tr, style: TextStyle(color: Colors.white , fontSize: 16.0 , fontWeight: FontWeight.bold),)
            ],
          ),
          SizedBox(height: 15.0,),
          Row(
