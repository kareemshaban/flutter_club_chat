            ...
            Column(
              children: [
                CircleAvatar(
                  ...
                  NetworkImage('${ASSETSBASEURL}AppUsers/${helper!.daily[index].user!.img}') : null,
                  radius: 20,
            ...
            Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Image(image: NetworkImage(ASSETSBASEURL + 'Levels/' + helper!.daily[index].user!.share_level_icon) , width: 30,),
                    const SizedBox(width: 10.0,),
                    Image(image: NetworkImage(ASSETSBASEURL + 'Levels/' + helper!.daily[index].user!.karizma_level_icon) , width: 30,),
                    const SizedBox(width: 10.0,),
                    Image(image: NetworkImage(ASSETSBASEURL + 'Levels/' + helper!.daily[index].user!.charging_level_icon) , width: 25,),

                  ],
                ),

                Text("ID:${helper!.daily[index].user!.tag}" , style: TextStyle(color: MyColors.unSelectedColor , fontSize: 13.0),),
            ...
            Column(
              children: [
                CircleAvatar(
                  ...
                  NetworkImage('${ASSETSBASEURL}AppUsers/${helper!.weekly[index].user!.img}') : null,
                  radius: 20,
            ...
            Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Image(image: NetworkImage(ASSETSBASEURL + 'Levels/' + helper!.weekly[index].user!.share_level_icon) , width: 30,),
                    const SizedBox(width: 10.0,),
                    Image(image: NetworkImage(ASSETSBASEURL + 'Levels/' + helper!.weekly[index].user!.karizma_level_icon) , width: 30,),
                    const SizedBox(width: 10.0,),
                    Image(image: NetworkImage(ASSETSBASEURL + 'Levels/' + helper!.weekly[index].user!.charging_level_icon) , width: 25,),

                  ],
                ),

                Text("ID:${helper!.weekly[index].user!.tag}" , style: TextStyle(color: MyColors.unSelectedColor , fontSize: 13.0),),
            ...
            Column(
              children: [
                CircleAvatar(
                  ...
                  NetworkImage('${ASSETSBASEURL}AppUsers/${helper!.monthly[index].user!.img}') : null,
                  radius: 20,
            ...
            Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Image(image: NetworkImage(ASSETSBASEURL + 'Levels/' + helper!.monthly[index].user!.share_level_icon) , width: 30,),
                    const SizedBox(width: 10.0,),
                    Image(image: NetworkImage(ASSETSBASEURL + 'Levels/' + helper!.monthly[index].user!.karizma_level_icon) , width: 30,),
                    const SizedBox(width: 10.0,),
                    Image(image: NetworkImage(ASSETSBASEURL + 'Levels/' + helper!.monthly[index].user!.charging_level_icon) , width: 25,),

                  ],
                ),

                Text("ID:${helper!.monthly[index].user!.tag}" , style: TextStyle(color: MyColors.unSelectedColor , fontSize: 13.0),),
