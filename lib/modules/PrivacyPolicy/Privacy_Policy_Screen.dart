  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        ...
        title: Text("privacy_policy_title".tr , style: TextStyle(color: MyColors.unSelectedColor,fontSize: 20.0) ,),
      ),
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              SizedBox(height: 5.0,),
              Text("privacy_policy".tr,style: TextStyle(color: Colors.white,fontSize: 20.0),),
              SizedBox(height: 20.0,),
              Text(''' Privacy Policy for Club Chat
          ...
          Application refers to Club Chat, the software program provided by the Company.
          
          Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Club Chat.
