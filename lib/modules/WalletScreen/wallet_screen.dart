...
import 'package:clubchat/models/Settings.dart';
import 'package:clubchat/modules/ChargingOperation/Charging_Operation_Screen.dart';
import 'package:clubchat/modules/Loading/loadig_screen.dart';
import 'package:clubchat/shared/constants/Contants.dart';
...
class _WalletScreenState extends State<WalletScreen> {
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            TextStyle(color: MyColors.unSelectedColor, fontSize: 15.0)) ,
                ),
            SizedBox(
              width: 10.0,
            )
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: 10.0,),
                                  Text("recharge_gold".tr , style: TextStyle(color: Colors.white , fontSize: 18.0 , fontWeight: FontWeight.bold),)
                                ],
                              ),
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                SizedBox(width: 10.0,),
                                Text("diamond_exchange".tr , style: TextStyle(color: Colors.white , fontSize: 18.0 , fontWeight: FontWeight.bold),)
                              ],
                            ),
                            SizedBox(height: 8.0,),
                            Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: TextField( controller: diamondTxt, decoration: InputDecoration(labelText: "diamond_exchange_inp_hint".tr ,
                                    ...
                                    style: const TextStyle(color: Colors.white , fontSize: 18.0), textAlign: TextAlign.center, cursorColor: MyColors.primaryColor ,  keyboardType: TextInputType.number,),
                                ),
                              ],
                            ),
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(width: 10.0,),
                                Text("diamond_exchange_rules".tr , style: TextStyle(color: Colors.white , fontSize: 18.0 , fontWeight: FontWeight.bold),)
                              ],
                            ),
                            SizedBox(height: 15.0,),
                            Column(
                            ...
                            Row(
                              children: [
                                Text('exchanged_gold'.tr , style: TextStyle(color: Colors.white , fontSize: 20.0 , fontWeight: FontWeight.bold),),
                                SizedBox(width: 15.0,),
  ...
  Widget googleProvider() => Container(
    width: double.infinity,
    ...
    child: Column(
      children: [
        Row(
          children: [
            Text("Google Pay" , style: TextStyle(color: MyColors.unSelectedColor , fontSize: 18.0),),
          ],
        ),
        Container(
          color: MyColors.unSelectedColor,
        ...
        Row(
          children: [
            ...
            SizedBox(width: 20.0,),
            Text("Google Pay" , style: TextStyle(color: MyColors.whiteColor , fontSize: 18.0), ),
