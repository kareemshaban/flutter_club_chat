  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        ...
        title: Text("contact_Us_title".tr , style: TextStyle(color: MyColors.unSelectedColor,fontSize: 20.0) ,),
      ),
      body: Container(
        ...
        color: MyColors.darkColor,
          ...
          child:
            Column(
              children: [
                Text("contact_Us_club_chat".tr,style: TextStyle(color: MyColors.unSelectedColor,fontSize: 20.0 ),textAlign:TextAlign.center,),
                ...
                SizedBox(width: 14.0,),
                Text("01000000000",style: TextStyle(fontSize: 17.0,color: Colors.white),),
                              ],
                            ),
                ...
                Column(
                  children: [
                    Container(
                      ...
                      child: Column(
                        children: [
                          Text('contact_Us_social_media'.tr,style: TextStyle(fontSize: 18.0,color: Colors.white),textAlign: TextAlign.center,),
                        ],
                      ),
                    ),
                  ],
