...
class _Account_Management_ScreenState extends State<Account_Management_Screen> {
    ...
    return  Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Container(
              decoration: BoxDecoration(color: Colors.black26 , borderRadius: BorderRadius.circular(15.0) , border: Border.all(color: MyColors.primaryColor ,
              width: 2.0)),
              padding: EdgeInsets.all(15.0),
              child: Row(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(getProviderName() , style: TextStyle(color: Colors.white , fontSize: 18.0),),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text('delete_account'.tr , style: TextStyle(color: Colors.white , fontSize: 20.0 , fontWeight: FontWeight.bold),)
                      ],
                    ),
                  ),
                ),
  ...
  showAlertDialog2(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      backgroundColor: MyColors.darkColor,
      title: Text("delete_account".tr , style: TextStyle(color: MyColors.primaryColor),),
      content: Text("delete_Account_msg".tr , style: TextStyle(color: MyColors.whiteColor),),
      actions: [
        okButton,
      ],
    );
