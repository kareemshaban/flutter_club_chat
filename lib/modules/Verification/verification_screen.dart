  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        ...
        title: Text("verification_title".tr , style: TextStyle(color: MyColors.unSelectedColor,fontSize: 20.0) ,),
      ),
      body: Container(
          ...
          children: [
            ...
            Container(
              ...
              child: MaterialButton(onPressed: (){();} ,
                child: Text("verification_verify".tr , style: TextStyle(color: Colors.white , fontSize: 18.0),),
              ),
            ),
          ],
        ),
